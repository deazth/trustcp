...
return [
    ...
    */
    ...
    'styles' => [
        ...
        'packages/afdzal/afd-theme/css/style.css',
        'packages/afdzal/afd-theme/css/icons.css',
        //'packages/amer/amer-theme/css/style.css'
    ],
    ...
    'project_logo'   => 'tr<b>US</b>t',
    // 'project_logo'   => '<div class="img-avatar"><img class="img-fluid" src="/img/tr_nu_tparent.png"  alt="trust logo"></div>',
    ...
    */
    ...
    'authentication_column'      => 'staff_no',
    'authentication_column_name' => 'Staff No',
