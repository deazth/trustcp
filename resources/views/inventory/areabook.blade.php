...
@section('header')
	<section class="container-fluid">
	  <h2>
        <span class="text-capitalize">Book Meeting Area</span>
  ...
  <div class="row">
  	<div class="{{ $crud->getCreateContentClass() }}">
  		...
  		@include('crud::inc.grouped_errors')
  		  ...
  		  <form method="post"
  		  		action="{{ route('userareabooking.dobooking') }}">
  			  {!! csrf_field() !!}
            ...
            <div id="saveActions" class="form-group">
                <button type="submit" class="btn btn-success">
                    <span class="las la-paste" role="presentation" aria-hidden="true"> Book Area</span>
                </button>
            </div>
  		  </form>
  	</div>
