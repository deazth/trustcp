...
@section('title', 'Building Utilization')
...
@section('header')
	<section class="container-fluid">
	  <h2>
        <span class="text-capitalize">Building Utilization</span>
	  </h2>
	</section>
@endsection
...
<div class="row">
	<div class="col-md-12 mb-1">
		<div class="card mb-3">
			<div class="card-body">
					<form action="{{ route('sbdash.rpt_ao_b_dur_daily')}}" method="get" id="searform">
		          ...
		          <div class="col-md-7 col-lg-6">
		            ...
		            <select class="form-control" name="bid" id="arealist">
		              @foreach($bl as $ar)
		                <option value="{{ $ar->id }}" @if($ar->id == $build->id) selected @endif >{{ $ar->GetLabel() }}</option>
		              @endforeach
		            </select>
		          </div>
