    ...
    <link rel="icon" sizes="32x32" type="image/png" href="/img/TrustNew.png" />
    @yield('before_styles')
    @stack('before_styles')
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-F7SZ6P7TBT"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-F7SZ6P7TBT');
    </script>
