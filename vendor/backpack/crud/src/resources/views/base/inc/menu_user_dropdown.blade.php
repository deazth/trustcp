<li class="nav-item dropdown pr-4">
  ...
  <div class="dropdown-menu {{ config('backpack.base.html_direction') == 'rtl' ? 'dropdown-menu-left' : 'dropdown-menu-right' }} mr-4 pb-1 pt-1">
    ...
    <a class="dropdown-item" href="{{ route('staff.detail', ['uid' => backpack_user()->id]) }}"><i class="las la-address-card"></i> My Profile</a>
    <a class="dropdown-item" href="{{ backpack_url('assistant') }}"><i class="las la-hands-helping"></i> My Assistants</a>
